...
- 나누면 두 배가 되는 사회를 꿈꾸는 사람들이 모여 함께 나누면서 변화를 만들어가고자하는 공유 플랫폼을 기획하게 되었습니다.
- 생필품을 필요로 하는 이웃에게 기부를 통해 일상생활이 편리해지도록 돕고자 **작은것부터 나누기 시작하자**는 기부 문화를 만들어 나가려고 합니다.
- 물품 기부의 특성상 접근성이 떨어진다는 단점이 있어 누구든지 쉽게 나눔을 받을 수 있도록 **접근성과 편의성을 고려**해 지하철역 위주로 나눔자판기를 배치했습니다.
<br/>
