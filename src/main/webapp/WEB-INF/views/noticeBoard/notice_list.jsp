...
<body>
		...
		<c:forEach items="${list}" var="dto">
        	<tr>
				...
				<td>
					...
					<a href="${pageContext.request.contextPath}/board/notice/${dto.b_index}">${dto.btitle}</a></td>
				<td>${dto.bdate}</td>
				<td>${dto.bhit}</td>	
       	   </tr>
       </c:forEach>  
	...
	<div align="center">
		<ul class="pagination justify-content-center">
			<c:if test="${pageMaker.prev}">
				<li class="page-item">
					<a href="notice_list${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a>
				</li>
			</c:if>
			...
			<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
				...
				<li class="page-item">
					<a href="notice_list${pageMaker.makeQuery(idx)}">${idx}</a>
				</li>
			</c:forEach>
				
			<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
				<li class="page-item">
				 	<a href="notice_list${pageMaker.makeQuery(pageMaker.endPage +1)}">다음</a>
				</li>
			</c:if><br>
		</ul>
	</div>
	...
	<div align="">
		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
  		...
  		<button type="button" class="btn btn-primary" onclick="location.href = '${pageContext.request.contextPath}/board/notice/write'">
				글쓰기
		</button>	
  		<br>
	</div>	
