...
<body>
	...
	<div class="charity-main-content">
		...
		<!-- Main Section -->
		<%-- <form id="updateForm"
			action="${pageContext.request.contextPath}/board/notice/modify/${content_view.b_index}"
			method="post"> --%>
			<table class="table">

				<tr>
					<td>번호</td>
					<td><input type="hidden" id="b_index"
						value="${content_view.b_index}"> ${content_view.b_index}</td>
				</tr>
				<tr>
					<td>조회수</td>
					<td><input type="hidden" id="b_index"
						value="${content_view.bhit}"> ${content_view.bhit}</td>
				</tr>
				<tr>
					<td>작성자</td>
					<td><input type="hidden" id="b_index"
						value="${content_view.member_id}">
						관리자</td>
				</tr>
				<tr>
					<td>제목</td>
					<td><input type="hidden" id="b_index"
						value="${content_view.btitle}"> ${content_view.btitle}</td>
				</tr>
				<tr>
					<td>내용</td>
					<td><input type="hidden" id="b_index"
						value="${content_view.bcontent}"> ${content_view.bcontent}</td>
				</tr>
				<tr>
					<td colspan="2"><sec:authorize access="hasRole('ADMIN')">
							<!-- 관리자버튼권한 -->
