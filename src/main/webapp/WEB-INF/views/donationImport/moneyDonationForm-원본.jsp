													...
													.request_pay(
															...
															function(rsp) {
																...
																$(location)
																		.attr(
																				'href',
																				"${pageContext.request.contextPath}/my/thank");
															});
										},
										error : function(e) {
...
<body>
	...
	<li><label>결제금액:</label> <input type="text" name="selectDirect"
		id="selectCardDirect" disabled /></li>

	<li class="charity-select-form"><label>(select)</label>
