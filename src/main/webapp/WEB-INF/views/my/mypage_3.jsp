													...
													<div class="col">
														<ul class="pagination justify-content-center">
															<li class="page-item"><c:if test="${pageMaker.prev}">
																	<a class="page-link"
																		href="${pageContext.request.contextPath}/my/mypage/_3${pageMaker.makeQuery(pageMaker.startPage - 1) }">prev</a>
																</c:if></li>
															...
															<li class="page-item"><c:forEach
																	...
																	<a href="${pageContext.request.contextPath}/my/mypage/_3${pageMaker.makeQuery(idx)}">${idx}</a>
																</c:forEach></li>
															...
															<li class="page-item"><c:if
																	...
																	<a class="page-link"
																		href="${pageContext.request.contextPath}/my/mypage/_3${pageMaker.makeQuery(pageMaker.endPage +1) }">next
																	</a>
																</c:if></li>
														</ul>
													</div>
