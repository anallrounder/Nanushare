					...
					<section class="module">
						<div class="module-inner">
							...
							<div class="side-bar">
								...
								<nav class="side-menu">
									<ul class="nav">
										<li><a href="mypage"><span class="fa fa-user">
											</span>&nbsp;&nbsp;Profile</a></li>
										...
										<ul class="page-numbers">
											...
											<c:if test="${pageMaker.prev}">
												<li><a class="previous page-umbers"
													href="${pageContext.request.contextPath}/my/give${pageMaker.makeQuery(pageMaker.startPage-1)}"><span
											...
											<c:forEach begin="${pageMaker.startPage}"
												...
												<li><a class="page-umbers"
													href="${pageContext.request.contextPath}/my/give${pageMaker.makeQuery(idx)}">${idx}</a></li>
											</c:forEach>
											...
											<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
												<li><a class="next page-umbers"
													href="${pageContext.request.contextPath}/my/give${pageMaker.makeQuery(pageMaker.endPage+1)}"><span
