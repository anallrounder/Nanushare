...
function getresource(barProgress){
	...
	jQuery(document).ready(function() {
		...
		getresource(barProgress.value);
		// value 값의 숫자를 입력함으로서 내용을 채울 수 있다.

		
		
		barProgress.progressbar({value:<sec:authentication property="principal.member.dntcnt"/>});
		barProgress.find(".ui-progressbar-value").css({
			"background" : "#2a786b"
		...
		console.log(typeof barProgress.value);
	});
