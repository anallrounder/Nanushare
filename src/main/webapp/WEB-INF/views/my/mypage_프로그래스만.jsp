...
<script type="text/javascript">
 ...
 jQuery(document).ready(function() {
     ...
     barProgress.eq(0).progressbar({value:<sec:authentication property="principal.member.dntcnt"/>});
...
<body>
 ...
 --%>
	<div class="skillst" id="maxmax">
		...
		<img src="/resources/my/그림2.png" height="80" width="80" style="visibility: hidden;"> 
		<img src="/resources/my/그림3.png" height="80" width="80" style="visibility: hidden;"> 
		<img src="/resources/my/그림4.png" height="80" width="80" style="visibility: hidden;"> 
		<img src="/resources/my/그림5.png" height="80" width="80" style="visibility: hidden;"> 
		<img src="/resources/my/그림6.png" height="80" width="80" style="visibility: hidden;">
		<hr />
