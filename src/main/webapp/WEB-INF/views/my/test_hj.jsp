...
<div>//o소개페이지, 오시는길 만들기</div>

<div>//o나눔내역조인하는 쿼리문 만들기</div>
<div>//x탈퇴하는 방법</div>
<div>//x회원수정 update</div>
<div>//o약관동의해야 넘어가는 것</div>
<div>//o나의 댓글내역 추가하기</div>


<div>수정사항 oitemdonation에 있는 icat_num을 FK로 설정 (itemiven에 icat_num이
	PK)</div>

<div>//단위통합테스트</div>
<div>//o이름는 hidden처리</div>
<div>//o탭처리 - 페이징처리해야함</div>
<div>//x수정할때 아이디는 수정이 안됨?-fk수정 가능한지 다시 찾아볼것</div>
