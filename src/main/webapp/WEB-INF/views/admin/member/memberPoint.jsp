									...
									<div class="row">
										<div class="col">
											<ul class="nav nav-tabs nav-justified">
												...
												<li class="nav-item">
													<a class="nav-link" href="/admin/member/moneydona?member_id=${pageMaker.member_id}">돈기부여내역</a>
												</li>
												<li class="nav-item">
													<a class="nav-link active" data-toggle="tab" href="#point">포인트내역</a>
												</li>
												<li class="nav-item">
											...
											<div class="tab-content">
												<div class="tab-pane fade show active" id="point">
						                            ...
						                            <form class="charity-volunteer-form" action="" method="post">
							                          ...
							                          <thead>
							                          	<tr bgcolor="a5a5a5">
							                              	<th style="border-left: none;">포인트 내역</th>
							                               	<th>포인트</th>
							                          ...
							                          <tbody>
														...
														<tr>
															<td colspan="3" align="center" style="border-left: none; border-right: none;">포인트 내역이 없습니다</td>
														</tr>
														</c:if>
							                            
							                            <c:if test="${! empty point}">
							                            <c:forEach items="${point}" var="pointdao">
							                            <c:forEach items="${pointdao.pointvo}" var="pdao">
							                            <tr>
							                               	<td style="border-left: none;">${pointdao.ename}</td> 
							                               	<td>${pdao.prtpnt}</td>
							                              	<td style="border-right: none;">${pdao.pdate}</td>
							                            </tr>
							                           </c:forEach>
							                           </c:forEach>
							                           </c:if>
											...
											<div class="charity-pagination">
												<ul class="page-numbers">
													...
													<c:if test="${pageMaker.prev}">
														<a class="previous pages-numbers" href="${pageContext.request.contextPath}/admin/member/point${pageMaker.makeQuery(pageMaker.startPage - 1) }"><i class="fa fa-angle-left"></i>prev</a>
													</c:if>
													</li>
													...
													<li>
														<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="idx">
															<c:out value="${pageMaker.cri.pageNum == idx?'':''}" />
																<a href="${pageContext.request.contextPath}/admin/member/point${pageMaker.makeQuery(idx)}">${idx}</a>
														</c:forEach>
													</li>
				
													<li>
														<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
															<a class="next page-numbers" href="${pageContext.request.contextPath}/admin/member/point${pageMaker.makeQuery(pageMaker.endPage +1) }">next<i class="fa fa-angle-right"></i></a>
														</c:if>
													</li>
												</ul>
											</div>
