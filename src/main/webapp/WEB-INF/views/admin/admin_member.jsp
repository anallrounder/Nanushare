									...
									<table class="table taWWble-striped projects">
										<thead>
											<tr bgcolor="a5a5a5">
												...
												<th>후원금기부횟수</th>
												<th>물품기부횟수</th>
												<th style="border-right: none;">블랙리스트 여부</th>
											</tr>
										</thead>
							            ...
							            <tbody>
											...
											<tr>
												<td style="border-left: none;">${status.count}</td>
												<td><a href="member_view?member_id=${member.member_id}">${member.member_id}</a></th>
												<td>${member.name}</td>
												<td>${member.signuppath}</td>
												<td>${member.dntcnt}</td>
												<td>${member.itemdntcnt}</td>
												<td style="border-right: none;">${member.bklist}</td>
											</tr>
											</c:forEach>
										</tbody>
									</table>
