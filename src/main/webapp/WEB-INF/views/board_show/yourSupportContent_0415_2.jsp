...
<body>
                            ...
                            <ul>
                                ...
                                <li class="charity-prev-post">
                                    ...
                                    <div class="charity-prev-artical">
                                        <a href="404.html" class="charity-post-arrow"><i class="fa fa-angle-double-left"></i> previous</a>
                                ...
                                <li class="charity-next-post">
                                    ...
                                    <div class="charity-next-artical">
                                        <a href="404.html" class="charity-post-arrow">Next <i class="fa fa-angle-double-right"></i></a>
	                                        ...
	                                        <div class="text-holder">
	                                           ...
	                                           <%--  <sec:authentication property="principal" var="pinfo" />
												...
												<c:if test="${pinfo.username eq vo.rid}"> 
		                                            <div class="charity-blog-social">
			                                            <i class="fa fa-edit"></i><a class="a-updateView" href="${pageContext.request.contextPath}/board/shows/updateView" onClick="updateView('${vo.b_index}','${vo.rid}','${vo.rdate}','${vo.rcontent}')" ><b>수정하기</b></a> &nbsp;
    ...
    <script type="text/javascript">
     		...
     		$.ajax({
    			...
    			success : function(result) {
    			 	 if(result == "SUCCESS"){
						...
						htmls += '<i class="fa fa-eraser"></i><a class="a-del" href="${pageContext.request.contextPath}/board/shows/delete/' + form.b_index + '/'+ r_num +'"><b>삭제하기</b></a></div>'
    					htmls += '</div>'
    					htmls += '</div>'
    					htmls += '</li>'
    	...
    	$(".a-del").click(function(event) { //id는 한번만 calss는 여러번 선택 가능.
     	...
     	// 댓글 수정 창 보기
     /* 	 $(".a-updateView").click(
     			 function updateView(b_index, rid, rcontent, rdate){
	     			alert(result+ "수정창 보기");
					...
					$(".rlist").replceWith(htmls); // 작성 결과 입력
