...
public class MemberPointVO {
	...
	//resultMap 사용을 위해 List<PointVO>가져옴
	...
	public MemberPointVO(String member_id, String pw, String name, String gender, Date birth, String signuppath,
			int pntnum, String authname, String bklist, int dntcnt, int itemdntcnt, String phone,
			List<PointVO> pointList) {
		super();
